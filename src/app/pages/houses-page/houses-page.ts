...
@Component({
  ...
  imports: [MiniMap, I18nPluralPipe],
...
export class HousesPage {
  ...
  houses = signal<HouseProperty[]>([
    {
      ...
      price: 500_000,
      lngLat: { lng: -0.961526, lat: 45.65649 },
  ...
  public housesCount = computed(() => this.houses().length);
  public houseCountMapping: Record<string, string> = {
    '=0': 'No houses found',
    '=1': 'One house available',
